...
import com.sc.android.chestwork.ConnectSocketActivity;
...
public class TcpClientConnector extends Object {
    ...
    private void connect(String mSerIP, int mSerPort) {
        ...
        try {
            ...
            while ((len = inputStream.read(buffer)) != -1) {
                ...
                ConnectSocketActivity.handler.sendMessage(message);
                Log.e("2", "123");
            }
        } catch (Exception e) {
            e.printStackTrace();
